...
Use the sidebar navigation or the [GitBook Navigation Index](SUMMARY.md) to explore specific sections:

- Section 01: Introduction to the ecosystem and growth pillars.
- Section 02: Detailed focus areas and activities of the four active clubs.
- Section 03: Central operations and campus coordination.
- Section 04: Leadership structure, the common operating model, and weekly/monthly reporting.
- Section 05: Joining rules, member lifecycles, and the 10-step Club Switching Protocol.
- Section 06: Faculty mentorship role and support model.
